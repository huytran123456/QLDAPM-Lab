...
public class ChangeEmail
{
      public const string body = "<!DOCTYPE HTML><html><head><meta charset=\"UTF-8\"/></head><body style=\"font-family: Arial;\">" +
                               ...
                               "</tr><tr><td><div style=\"font-weight:bold;font-size:20px;line-height:25px;text-align:center;color:#2e3454;\">VERIFICATION EMAIL!</div></td></tr>" +
                               "<tr><td><div class=\"content\"><p style=\"color: #2e3454;\">Welcome my_email_replace<br><br>To change the account, please smartly enter the confirmation code below</p>" +
